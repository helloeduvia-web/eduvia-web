...
function Home({go,openAssessment}){return <main>
  <section className="hero"><div className="container hero-grid"><div className="hero-copy"><span className="eyebrow">GUIDED GLOBAL STUDY ABROAD PLATFORM</span><h1>Make your study-abroad journey <em>clearer.</em></h1><p>Discover the right destination, course and next step through one guided journey built around your profile.</p><div className="hero-buttons"><button className="primary" onClick={openAssessment}>Start Free Assessment <Icon name="arrow"/></button><button className="secondary" onClick={()=>go('destinations')}>Explore Destinations</button></div><div className="trust-row"><span><Icon name="check"/> 5 focused questions</span><span><Icon name="check"/> Immediate value</span><span><Icon name="check"/> Personalised pathway</span></div></div><div className="hero-media"><img className="hero-photo" src="https://images.unsplash.com/photo-1781583847268-46d15bfe5609?auto=format&fit=crop&w=1500&q=90" alt="Three university students collaborating together"/><div className="float-card"><span>Profile readiness</span><strong>82 <small>/ 100</small></strong><div className="mini-bar"><i/></div></div></div></div></section>
  ...
  <section className="section global-story"><div className="container"><div className="section-row"><div><span className="eyebrow">THE EDUVIA JOURNEY</span><h2>See the journey. <em>Understand the next step.</em></h2><p>Real-world context helps you compare destinations and picture what your international study journey can look like.</p></div></div><div className="story-grid student-story-grid"><article className="story-card story-wide"><img src="https://images.unsplash.com/photo-1627556704353-016baeb12c79?auto=format&fit=crop&w=1300&q=88" alt="University graduates celebrating together"/><div><span>GLOBAL COMMUNITY</span><h3>Think beyond borders.</h3><p>Explore destinations, people and opportunities around the world from one student-first platform.</p></div></article><article className="story-card"><img src="https://images.unsplash.com/photo-1517486808906-6ca8b3f04846?auto=format&fit=crop&w=1300&q=88" alt="University students on campus together"/><div><span>DESTINATIONS</span><h3>Find your place in the world.</h3><p>Compare countries with a clearer view of fit, timing and pathways.</p></div></article></div></div></section>
...
function Intakes({openAssessment}){
  ...
  return <main className="inner-page intake-page">
    ...
    </div><div className="inner-hero-image"><img src="https://images.unsplash.com/photo-1522202176988-66273c2fd55f?auto=format&fit=crop&w=1300&q=88" alt="Students studying together on campus"/></div></div></section>
