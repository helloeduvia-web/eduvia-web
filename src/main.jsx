...
function Home({go,openAssessment}){return <main>
  ...
  <section className="section global-story"><div className="container"><div className="section-row"><div><span className="eyebrow">THE EDUVIA JOURNEY</span><h2>See the journey. <em>Understand the next step.</em></h2><p>Real-world context helps you compare destinations and picture what your international study journey can look like.</p></div></div><div className="story-grid student-story-grid"><article className="story-card story-wide"><img src="https://unsplash.com/photos/-uHVRvDr7pg/download?force=true" alt="Students collaborating on campus"/><div><span>GLOBAL COMMUNITY</span><h3>Think beyond borders.</h3><p>Explore destinations, people and opportunities around the world from one student-first platform.</p></div></article><article className="story-card"><img src="https://unsplash.com/photos/-uHVRvDr7pg/download?force=true" alt="International students representing different countries"/><div><span>DESTINATIONS</span><h3>Find your place in the world.</h3><p>Compare countries with a clearer view of fit, timing and pathways.</p></div></article></div></div></section>
...
function Intakes({openAssessment}){
  ...
  return <main className="inner-page intake-page">
    ...
    </div><div className="inner-hero-image"><img src="https://unsplash.com/photos/8VRfnLvCryY/download?force=true" alt="Students preparing for international study"/></div></div></section>
